...
int Engine::Init(const char* title, int xPos, int yPos, int width, int height, int flags)
{
	...
	m_player.SetRects( {1024,0,128,128 }, {512,384,128,128 } ); // First {} is src rectangle, and second {} destination rect
